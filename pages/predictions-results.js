            ...
            {bins.map((binCount, index) => {
              ...
              return (
                <div key={index} className="flex items-center">
                  <div className="w-20 text-xs text-gray-600">{binStart}-{binEnd}</div>
          ...
          {results.questions.map((question, index) => (
            <div key={question.id} className="border-b border-gray-200 pb-4 last:border-0">
              ...
              <p className="text-lg text-primary font-medium">
                {participant.answers[question.id] || 'No answer'}
              </p>
            </div>
          ))}
        </div>
      ...
      <div className="max-w-6xl mx-auto py-8 px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-4">
            {results.totalParticipants} people have made their predictions!
          </p>
          <Link
            href="/wedding-predictions"
            className="text-primary hover:text-primary-dark"
