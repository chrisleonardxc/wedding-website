...
// Add this function to create the likes table if it doesn't exist
export async function initLikesTable(db) {
  return db.exec(`
...
// Update the initDatabase function to create the likes table
export async function initDatabase() {
  const db = await openDb();
  
  // Initialize tables
  await initPhotosTable(db);
  await initLikesTable(db); // Add this line
